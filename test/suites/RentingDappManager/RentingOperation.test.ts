...
export const RentingOperation = () =>
    describe('Working of rental operation', () => {
        ...
        it('successful completion of rent with undamaged product return', async () => {
            ...
            const filter1 = productManagerInstanceESN.filters.NewRentalContract(null, wallet2.address, null, null, null, null, null, null, null, null);
            ...
            const parsedLogs7 =  receipt7.logs.map((log) =>
                rentalAgreementESN_1.interface.parseLog(log)
            ); 
        });
        ...
        it('successful completion of rent with damaged product return', async () => {
            ...
            try {
                ...
                ok(
                    error?.message?.includes("Please terminate contract using the 'terminatetWithAdditionalCharges' function"),
