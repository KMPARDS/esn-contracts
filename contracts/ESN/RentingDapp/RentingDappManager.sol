...
contract RentingDappManager  
{
    ...
    event ProductDetails(address indexed lessor, address item, string _name, string _description, string _location, uint256 _maxRent, uint256 _security, uint256 _cancellationFee, bytes32 indexed _categoryId, uint48 _listDate);
    ...
    function addItem (string memory _name, string memory _location, uint256 _maxRent, uint256 _security, uint256 _cancellationFee, string memory _description, bytes32 _categoryId, uint48 _listDate) public /*onlyAuthorised*/
    {
        ...
        emit ProductDetails(msg.sender, address(_newProduct), _name, _description, _location, _maxRent, _security, _cancellationFee, _categoryId, _listDate); 
    }
